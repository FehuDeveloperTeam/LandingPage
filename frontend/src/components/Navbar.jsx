...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-[100] bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5">
      ...
      {/* Mobile Menu Overlay - CORREGIDO: Fondo sólido para evitar transparencia con el contenido */}
      {menuOpen && (
        <div className="fixed inset-0 top-20 z-50 md:hidden bg-white dark:bg-gray-900 px-6 py-8 animate-in fade-in slide-in-from-top-4 duration-300 overflow-y-auto">
